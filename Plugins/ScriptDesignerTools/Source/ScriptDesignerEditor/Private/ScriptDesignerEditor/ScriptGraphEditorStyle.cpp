...
TSharedPtr<FSlateStyleSet> FScriptGraphEditorStyle::StyleSet = nullptr;
...
void FScriptGraphEditorStyle::Initialize()
{
...
void FScriptGraphEditorStyle::Shutdown()
{
    if (StyleSet.IsValid())
    {
...
const FName& FScriptGraphEditorStyle::GetStyleSetName()
{
