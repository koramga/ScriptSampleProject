...
class SCRIPTDESIGNEREDITOR_API FConnectionDrawingPolicy_ScriptGraph : public FConnectionDrawingPolicy
{
protected:
	UEdGraph* GraphObj;
...
public :
	FConnectionDrawingPolicy_ScriptGraph(int32 InBackLayerID, int32 InFrontLayerID, float ZoomFactor, const FSlateRect& InClippingRect, FSlateWindowElementList& InDrawElements, UEdGraph* InGraphObj);
